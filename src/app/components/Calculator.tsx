...
export const SimpleCalculator = () => {
    ...
    return (
        <>
            <div className="p-5 w-4/5 md:w-96 lg:w-96 bg-white shadow-lg rounded-xl" >git init
                <h1 className="text-3xl mb-4">Simple Calculator</h1>
                <Input className="w-full shadow-lg border-0 py-6" type="text" placeholder="First number" value={num1} onChange={(event: any) => setNum1(event.target.value)} />
                <Input className="w-full my-3 shadow-lg border-0 py-6" type="text" placeholder="Second number" value={num2} onChange={(event: any) => setNum2(event.target.value)} />
